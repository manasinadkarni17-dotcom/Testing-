...
- Name: auth\email-password.spec.ts >> Authentication — Email + Password >> TC-AUTH-01-03 · Password field masks input
- Location: tests\auth\email-password.spec.ts:65:7
