...
- Name: auth\email-password.spec.ts >> Authentication — Email + Password >> TC-AUTH-01-01 · Login page renders all required elements
- Location: tests\auth\email-password.spec.ts:20:7
