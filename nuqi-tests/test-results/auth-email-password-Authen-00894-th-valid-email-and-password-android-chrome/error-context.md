...
- Name: auth\email-password.spec.ts >> Authentication — Email + Password >> TC-AUTH-01-02 · Successful login with valid email and password
- Location: tests\auth\email-password.spec.ts:44:7
...
- generic [ref=e3]:
  ...
  - main [ref=e6]:
    - generic [ref=e7]:
      ...
      - link "https://uat.nuqiwealth.com" [ref=e11] [cursor=pointer]:
      ...
      - generic [ref=e13]:
        - link "GET IT ON Google Play" [ref=e14] [cursor=pointer]:
