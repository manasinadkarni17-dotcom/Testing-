...
- Name: auth\email-password.spec.ts >> Authentication — Email + Password >> TC-AUTH-01-04 · Session persists on page reload after login
- Location: tests\auth\email-password.spec.ts:77:7
